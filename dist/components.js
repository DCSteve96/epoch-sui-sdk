...
__export(components_exports, {
  PoweredByEpoch: () => PoweredByEpoch,
  VestingWidget: () => VestingWidget
});
...
var EPOCH_LOGO = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: [
  ...
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "12", y1: "2", x2: "12", y2: "22", stroke: "#6FBCF0", strokeWidth: "1.2", strokeDasharray: "2.5 2" }),
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "2", y1: "8.5", x2: "22", y2: "15.5", stroke: "#6FBCF0", strokeWidth: "1.2", strokeDasharray: "2.5 2" }),
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "22", y1: "8.5", x2: "2", y2: "15.5", stroke: "#6FBCF0", strokeWidth: "1.2", strokeDasharray: "2.5 2" })
] });
var BADGE_SIZE = {
...
function IconLinear({ size = 36 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: "0 0 48 48", fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "6", y1: "42", x2: "42", y2: "6", stroke: "#6FBCF0", strokeWidth: "2", strokeLinecap: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "6", cy: "42", r: "3", fill: "rgba(111,188,240,0.3)", stroke: "#6FBCF0", strokeWidth: "1.5" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "24", cy: "24", r: "3", fill: "rgba(111,188,240,0.3)", stroke: "#6FBCF0", strokeWidth: "1.5" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "42", cy: "6", r: "3", fill: "#6FBCF0" })
  ] });
}
function IconCliff({ size = 36 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: "0 0 48 48", fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "6", y: "30", width: "8", height: "14", rx: "1.5", fill: "rgba(111,188,240,0.12)", stroke: "#6FBCF0", strokeWidth: "1.4" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "20", y: "20", width: "8", height: "24", rx: "1.5", fill: "rgba(111,188,240,0.12)", stroke: "#6FBCF0", strokeWidth: "1.4" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "34", y: "6", width: "8", height: "38", rx: "1.5", fill: "rgba(111,188,240,0.25)", stroke: "#6FBCF0", strokeWidth: "1.4" })
  ] });
}
function IconHybrid({ size = 36 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: "0 0 48 48", fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polyline", { points: "6,42 6,24 22,24", stroke: "#6FBCF0", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "22", y1: "24", x2: "42", y2: "6", stroke: "#6FBCF0", strokeWidth: "2", strokeLinecap: "round", strokeDasharray: "3 2.5" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "22", cy: "24", r: "4", fill: "rgba(111,188,240,0.2)", stroke: "#6FBCF0", strokeWidth: "1.5" })
  ] });
}
var VEST_TYPES = [
...
function VestingWidget({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width, fontFamily: "system-ui, -apple-system, sans-serif" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
    background: t.card,
    border: `1px solid ${t.border}`,
    borderRadius: 16,
    padding: 20,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 700, fontSize: 16, color: t.text }, children: "Create Vault" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: 4, background: t.bg, borderRadius: 10, padding: 3 }, children: ["single", "multi"].map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setMode(m), style: {
        padding: "4px 12px",
        borderRadius: 8,
        border: "none",
        cursor: "pointer",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Vesting type" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }, children: VEST_TYPES.map(({ id, label, Icon, desc }) => {
        const active = vestType === id;
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { onClick: () => setVestType(id), style: {
          display: "flex",
          flexDirection: "column",
          alignItems: "center",
          gap: 7,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 30 }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 700, fontSize: 12, color: active ? t.accent : t.muted }, children: label }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 9, color: "#52525b", lineHeight: 1.4, textAlign: "center" }, children: desc })
        ] }, id);
      }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Amount" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          type: "number",
    ...
    vestType !== "linear" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: grid2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Cliff date" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "date", value: cliffDate, onChange: (e) => setCliffDate(e.target.value), style: inputStyle })
      ] }),
      vestType === "hybrid" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Cliff % unlock" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "number",
    ...
    vestType !== "cliff" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: grid2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Linear start" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "date", value: start, onChange: (e) => setStart(e.target.value), style: inputStyle })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Linear end" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "date", value: end, onChange: (e) => setEnd(e.target.value), style: inputStyle })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { height: 1, background: t.border } }),
    mode === "single" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Beneficiary address" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          type: "text",
    ...
    mode === "multi" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: labelStyle, children: "Beneficiaries" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 12, fontWeight: 700, color: totalPct === 100 ? t.green : t.red }, children: [
          totalPct,
          "%",
          totalPct !== 100 ? " \u2014 must be 100%" : " \u2713"
        ] })
      ] }),
      rows.map((row, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 12, color: t.muted, width: 16, flexShrink: 0 }, children: [
          i + 1,
          "."
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, color: t.muted }, children: "%" }),
        rows.length > 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
    ...
    status === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { margin: 0, fontSize: 12, color: t.red }, children: [
      "Error: ",
      errMsg
    ] }),
    status === "done" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
      padding: "10px 14px",
      borderRadius: 10,
      background: "rgba(52,211,153,.06)",
      border: "1px solid rgba(52,211,153,.2)"
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", fontSize: 12, fontWeight: 600, color: t.green }, children: "Vault created!" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", justifyContent: "center", paddingTop: 2 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PoweredByEpoch, { size: "sm" }) })
  ] }) });
}
